...
class PilihMrkMeterBottomSheet extends StatefulWidget {
  const PilihMrkMeterBottomSheet({super.key});

  @override
  State<PilihMrkMeterBottomSheet> createState() =>
      _PilihMrkMeterBottomSheetState();
}

class _PilihMrkMeterBottomSheetState extends State<PilihMrkMeterBottomSheet> {
  final TextEditingController _searchController = TextEditingController();
  String _selectedGolongan = 'MRK A'; // Default selected
